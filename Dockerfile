...
COPY docker/fcash-build.sh /usr/local/bin/fcash-build
RUN chmod 0755 /usr/local/bin/fcash-build

WORKDIR /workspace
ENTRYPOINT ["/usr/local/bin/fcash-build"]
